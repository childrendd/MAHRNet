...
* When we use datasets other than those mentioned above for training, we need to change the dataset to the format required by the code first, and in particular, we need to change the labels to an 8bit format before we can train them.
